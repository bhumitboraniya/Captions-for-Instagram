...
import static com.captions.DataStoreInString.lyrics;
...
public class DetailsLyrics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            mInterstitialAd.setAdListener(new com.google.android.gms.ads.AdListener() {
                ...
                public void onAdClosed() {
                    if (adfav == 1) {
                        ...
                        SQLDatabaseFavorite database_favorite_list = new SQLDatabaseFavorite(DetailsLyrics.this);
                        database_favorite_list.openDB();
                        database_favorite_list.insertfavorite(FragmentLyrics.list_name1[tab], lyrics[tab]);
                    ...
                    if (adcopy == 2) {
                        ...
                        ClipData clip = ClipData.newPlainText("FullDetailsTv", lyrics[tab]);
        ...
        final DetailsLyrics.PagePagerAdapter adapter = new PagePagerAdapter(DetailsLyrics.this, lyrics,Answer);
        ...
        sharebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, lyrics[tab]);
    ...
    public class PagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            txt_page_index.setText(String.valueOf((position + 1) + "/" + lyrics.length));
            ...
            labelTv.setText("Lyrics Captions");
        ...
        switch (item.getItemId()) {
            ...
            case R.id.FavoriteList:
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    SQLDatabaseFavorite database_favorite_list = new SQLDatabaseFavorite(DetailsLyrics.this);
                    database_favorite_list.openDB();
                    database_favorite_list.insertfavorite(FragmentLyrics.list_name1[tab], DataStoreInString.lyrics[tab]);
                    database_favorite_list.closeDB();
                }
                return true;
