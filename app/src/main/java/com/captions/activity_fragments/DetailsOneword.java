...
import static com.captions.DataStoreInString.attitude;
import static com.captions.DataStoreInString.oneword;
...
public class DetailsOneword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            mInterstitialAd.setAdListener(new com.google.android.gms.ads.AdListener() {
                ...
                public void onAdClosed() {
                    if (adfav == 1) {
                        ...
                        SQLDatabaseFavorite database_favorite_list1 = new SQLDatabaseFavorite(DetailsOneword.this);
                        database_favorite_list1.openDB();
                        database_favorite_list1.insertfavorite(FragmentOneword.list_name1[tab], DataStoreInString.oneword[tab]);
                    ...
                    if (adcopy == 2) {
                        ...
                        ClipData clip = ClipData.newPlainText("FullDetailsTv", DataStoreInString.oneword[tab]);
        ...
        final DetailsOneword.PagePagerAdapter adapter = new PagePagerAdapter(DetailsOneword.this, DataStoreInString.oneword,Answer);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                tab++;
                viewPager.setCurrentItem(tab);
                if (tab== oneword.length)
                {
                    Toast.makeText(getApplicationContext(), "First Caption!", Toast.LENGTH_SHORT).show();
                    tab=0;
                    viewPager.setCurrentItem(tab);
                }
            }
        ...
        sharebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, oneword[tab]);
        ...
        copybtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    int tab = viewPager.getCurrentItem();
                    ClipboardManager clipboard = (ClipboardManager) getSystemService(CLIPBOARD_SERVICE);
                    ClipData clip = ClipData.newPlainText("FullDetailsTv", oneword[tab]);
                    Toast.makeText(getApplicationContext(), "Text Is Copied To clipboard ", Toast.LENGTH_LONG).show();
                    clipboard.setPrimaryClip(clip);
    ...
    public class PagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            txt_page_index.setText(String.valueOf((position + 1) + "/" + oneword.length));
            ...
            labelTv.setText("One Word Captions");
        ...
        switch (item.getItemId()) {
            ...
            case R.id.FavoriteList:
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    int tab = viewPager.getCurrentItem();
                    Toast.makeText(getApplication(), "Add To Favorite List", Toast.LENGTH_LONG).show();
                    SQLDatabaseFavorite database_favorite_list = new SQLDatabaseFavorite(DetailsOneword.this);
                    database_favorite_list.openDB();
                    database_favorite_list.insertfavorite(FragmentOneword.list_name1[tab], DataStoreInString.oneword[tab]);
