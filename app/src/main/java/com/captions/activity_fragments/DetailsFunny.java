...
import static com.captions.DataStoreInString.pages;
import static com.captions.DataStoreInString.pages;
import static com.captions.DataStoreInString.pages;

public class DetailsFunny extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            mInterstitialAd.setAdListener(new com.google.android.gms.ads.AdListener() {
                ...
                public void onAdClosed() {
                    if (adfav == 1) {
                        ...
                        SQLDatabaseFavorite database_favorite_list = new SQLDatabaseFavorite(DetailsFunny.this);
                        database_favorite_list.openDB();
                        database_favorite_list.insertfavorite(FragmentFunnyy.list_name[tab], DataStoreInString.pages[tab]);
                    ...
                    if (adcopy == 2) {
                        ...
                        ClipData clip = ClipData.newPlainText("FullDetailsTv", pages[tab]);
        ...
        final PagePagerAdapter adapter = new PagePagerAdapter(DetailsFunny.this, pages, Answer);
        ...
        sharebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, pages[tab]);
    ...
    public class PagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            txt_page_index.setText(String.valueOf((position + 1) + "/" + pages.length));
            ...
            labelTv.setText("Funny Captions");
