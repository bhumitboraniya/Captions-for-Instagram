...
import static com.captions.DataStoreInString.couples;
...
public class DetailsCouples extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            mInterstitialAd.setAdListener(new com.google.android.gms.ads.AdListener() {
                ...
                public void onAdClosed() {
                    if (adfav == 1) {
                        ...
                        SQLDatabaseFavorite database_favorite_list1 = new SQLDatabaseFavorite(DetailsCouples.this);
                        database_favorite_list1.openDB();
                        database_favorite_list1.insertfavorite(FragmentCouples.list_name1[tab], DataStoreInString.pages[tab]);
                    ...
                    if (adcopy == 2) {
                        ...
                        ClipData clip = ClipData.newPlainText("FullDetailsTv", DataStoreInString.couples[tab]);
        ...
        final DetailsCouples.PagePagerAdapter adapter = new PagePagerAdapter(DetailsCouples.this, DataStoreInString.couples,Answer);
        ...
        sharebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, couples[tab]);
        ...
        copybtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    int tab = viewPager.getCurrentItem();
                    ClipboardManager clipboard = (ClipboardManager) getSystemService(CLIPBOARD_SERVICE);
                    ClipData clip = ClipData.newPlainText("FullDetailsTv",couples[tab]);
                    Toast.makeText(getApplicationContext(), "Text Is Copied To clipboard ", Toast.LENGTH_LONG).show();
                    clipboard.setPrimaryClip(clip);
    ...
    public class PagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            txt_page_index.setText(String.valueOf((position + 1) + "/" + couples.length));
        ...
        switch (item.getItemId()) {
            ...
            case R.id.FavoriteList:
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    int tab = viewPager.getCurrentItem();
                    Toast.makeText(getApplication(), "Add To Favorite List", Toast.LENGTH_LONG).show();
                    SQLDatabaseFavorite database_favorite_list = new SQLDatabaseFavorite(DetailsCouples.this);
                    database_favorite_list.openDB();
                    database_favorite_list.insertfavorite(FragmentCouples.list_name1[tab], DataStoreInString.couples[tab]);
